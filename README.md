...
This is a local chat application written in C++ using Qt.
The program opens two separate windows on the same computer, simulating a conversation between two users.
Users can send and receive messages in real-time, providing a simple yet interactive chat experience.
