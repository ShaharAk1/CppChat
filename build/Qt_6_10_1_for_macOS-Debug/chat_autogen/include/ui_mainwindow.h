...
"padding: 20px;"));
        ...
        titleBar->setStyleSheet(QString::fromUtf8("background-color:  #798ABA;\n"
"padding: 0;"));
...
"border-radius: 5px;"));
        ...
        sendBar->setMinimumSize(QSize(440, 70));
        sendBar->setAutoFillBackground(false);
        sendBar->setStyleSheet(QString::fromUtf8("background-color: #798ABA;"));
        ...
        pushButton->setGeometry(QRect(340, 20, 32, 41));
...
"border-radius: 30px;"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("assets/sendicon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::On);
        pushButton->setIcon(icon1);
        pushButton->setIconSize(QSize(32, 32));
        formLayout = new QFormLayout(sendBar);
        formLayout->setObjectName("formLayout");
        formLayout->setSizeConstraint(QLayout::SizeConstraint::SetMaximumSize);
        ...
        formLayout->setContentsMargins(12, 0, 12, 12);
...
""));
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, lineEdit);
